...
// EXAMPLE: PRG — Handle POST submission first (PRG pattern)
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // EXAMPLE: VALIDATION — Basic validation rules
    $errors = [];
    ...
    if (empty($errors)) {
        // EXAMPLE: PREPARED_INSERT — Use a prepared statement to avoid SQL injection
...
<section class="section">
  ...
  <!-- EXAMPLE: ESCAPING_OUTPUT — Escape dynamic content in the template -->
