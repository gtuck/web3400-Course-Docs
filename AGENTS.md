...
- Run `rg TODO -n` at the repo root; resolve or annotate anything that shouldn't ship to students. Exception: `TODO(you)` markers in project descriptions are intentional student scaffolds (see Editing Conventions) — leave them.
